...
public class HomePage {
    ...
    public static String SignInPortalHomepageMenu_xpath ="/html/body/div/nav/div/ul/a[2]";
    ...
    public static void click_signin_portal_menu_link() throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.xpath(SignInPortalHomepageMenu_xpath)).click();
    }
}
